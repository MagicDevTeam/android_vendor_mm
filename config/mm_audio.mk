...
ALARM_PATH := vendor/mm/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/mm/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/mm/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/mm/prebuilt/common/media/audio/ui
